<!DOCTYPE html>
<html lang="en">
  <!-- /*! 404.php 3.?.?? too many updates. | MIT -->
  <head>
    ...
    <!-- Meta tags -->
    <meta name="name" content="404 - Oops">
    ...
    <meta name="application-name" content="404 - Oops">
    <meta name="author" content="/humans.txt">    
    
    <!-- Open Graph meta tags -->
    <meta property="og:title" content="404 - Oops">
    ...
    <?php
      ...
      $errLineOne = "It appears the site you were looking for is no longer located where you thought it was.";
